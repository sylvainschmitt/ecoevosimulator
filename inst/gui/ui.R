...
ui <- dashboardPage(
    ...
    dashboardSidebar(
        ...
        sliderInput("timestep", "Length of time step (in year):",
        ...
        conditionalPanel(
            condition = "input.topography == 'squarediamond'",
            sliderInput("ruggedness", "Environmental gradient ruggedness:",
                        min = 0, max = 10, value = 1, step = 1)
        ),
        ...
        numericInput("alpha", "Intercept for the Bernoulli distribution:",
                     min = -4, max = 4, value = -1.32, step = 0.1),
        numericInput("beta", "Slope of previous NCI for the Bernoulli distribution:",
                     min = -4, max = 4, value = 0.003, step = 0.1),
        ...
        sliderInput("Rpollination", "Pollination radius:",
                    min = 0, max = 50, value = 1),
        sliderInput("Rdispersion", "Dispersion radius:",
                    min = 0, max = 50, value = 1),
